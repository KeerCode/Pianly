...
Go to the [Releases](https://github.com/KeerCode/Pianly/releases) page:
...
> **macOS:** Not notarized. If the app won't open, run this in Terminal then try again:
> ```
> xattr -cr /Applications/Pianly.app
> ```
> Or right-click the app → **Open** → **Open** again. One-time only.
